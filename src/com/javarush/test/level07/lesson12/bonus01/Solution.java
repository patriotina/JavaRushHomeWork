...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            int cage = Integer.parseInt(reader.readLine());
            int cw = Integer.parseInt(reader.readLine());
            int ctl = Integer.parseInt(reader.readLine());
            Cat cat = new Cat(name, cage, cw, ctl);
